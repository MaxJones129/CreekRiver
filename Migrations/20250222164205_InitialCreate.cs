    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "noahsux@gmail.com", "Noah", "Allen" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 1, "https://tnstateparks.com/assets/images/content-images/campgrounds/249/colsp-area2-site74.jpg", "Red Fox" },
                    { 3, 2, "https://tnstateparks.com/assets/images/content-images/campgrounds/249/colsp-area2-site75.jpg", "White Oak" },
                    { 4, 1, "https://tnstateparks.com/assets/images/content-images/campgrounds/249/colsp-area2-site76.jpg", "Blue Heron" },
                    { 5, 3, "https://tnstateparks.com/assets/images/content-images/campgrounds/249/colsp-area2-site77.jpg", "Golden Eagle" },
                    { 6, 2, "https://tnstateparks.com/assets/images/content-images/campgrounds/249/colsp-area2-site78.jpg", "River Birch" }
                });

            migrationBuilder.InsertData(
                table: "Reservations",
                columns: new[] { "Id", "CampsiteId", "CheckinDate", "CheckoutDate", "UserProfileId" },
                values: new object[] { 1, 1, new DateTime(2025, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 3, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 });
